...
2. - [x] Context compaction — [`context-compaction.md`](./context-compaction.md)
   - [x] Disambiguate max_tokens stop reason (output cap vs. context exhaustion) — [`context-compaction.md#error-reporting-stop_reason-max_tokens`](./context-compaction.md#error-reporting-stop_reason-max_tokens)
