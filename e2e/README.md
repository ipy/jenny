...
The e2e suite verifies that jenny produces behavior compatible with the reference agent across:
...
```bash
go test ./e2e/... -v -run TestCLI
go test ./e2e/... -v -run TestStreamJSON
go test ./e2e/... -v -run TestAPIProtocol
go test ./e2e/... -v -run TestSystemPrompt
go test ./e2e/... -v -run TestToolCall
go test ./e2e/... -v -run TestCostTracking
go test ./e2e/... -v -run TestSession
go test ./e2e/... -v -run TestNormalization
```
